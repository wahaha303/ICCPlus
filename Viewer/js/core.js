...
add('link', { rel: 'modulepreload', href: basePath + 'js/chunk-vendors.tCGESFhu.js', crossorigin: '' });
add('script', { type: 'module', src: basePath + 'js/app.CGfc8gBS.js', crossorigin: '' });
...
addEventListener('DOMContentLoaded', () => {
    ...
    polyfillScript.onload = function(){
        var entrySrc = basePath + 'js/app-legacy.i3m3xEcE.js';
