...
add('link', { rel: 'modulepreload', href: basePath + 'js/chunk-vendors.egVnIrbL.js', crossorigin: '' });
add('script', { type: 'module', src: basePath + 'js/app.RAYMS3V3.js', crossorigin: '' });
...
addEventListener('DOMContentLoaded', () => {
    ...
    polyfillScript.onload = function(){
        var entrySrc = basePath + 'js/app-legacy.CTp9UpBV.js';
