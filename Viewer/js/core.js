...
add('script', { type: 'module', src: basePath + 'js/app.CbvIbP8a.js', crossorigin: '' });
add('script', {
type: 'module',
text: `
    import.meta.url;
...
addEventListener('DOMContentLoaded', () => {
    ...
    polyfillScript.onload = function(){
        var entrySrc = basePath + 'js/app-legacy.BUcuDajm.js';
    ...
    legacyEntry.setAttribute('data-src', basePath + 'js/app-legacy.BUcuDajm.js');
