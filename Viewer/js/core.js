...
add('script', { type: 'module', src: basePath + 'js/app.3yRobVZa.js', crossorigin: '' });
add('script', {
type: 'module',
text: `
    import.meta.url;
...
addEventListener('DOMContentLoaded', () => {
    ...
    polyfillScript.onload = function(){
        var entrySrc = basePath + 'js/app-legacy.CNcGzjnI.js';
    ...
    legacyEntry.setAttribute('data-src', basePath + 'js/app-legacy.CNcGzjnI.js');
