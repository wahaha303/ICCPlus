...
add('script', { type: 'module', src: basePath + 'js/app.pMuIu2J8.js', crossorigin: '' });
add('script', {
type: 'module',
text: `
    import.meta.url;
...
addEventListener('DOMContentLoaded', () => {
    ...
    polyfillScript.onload = function(){
        var entrySrc = basePath + 'js/app-legacy.s_pOQ4yu.js';
    ...
    legacyEntry.setAttribute('data-src', basePath + 'js/app-legacy.s_pOQ4yu.js');
