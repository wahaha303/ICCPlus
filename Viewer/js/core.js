...
add('link', { rel: 'stylesheet', href: basePath + 'css/app.DsGj202b.css', crossorigin: '' });
add('link', { rel: 'modulepreload', href: basePath + 'js/chunk-vendors.BkzMju_X.js', crossorigin: '' });
add('script', { type: 'module', src: basePath + 'js/app.BcaDlQXM.js', crossorigin: '' });
...
addEventListener('DOMContentLoaded', () => {
    ...
    polyfillScript.onload = function(){
        var entrySrc = basePath + 'js/app-legacy.BAd-_ci5.js';
