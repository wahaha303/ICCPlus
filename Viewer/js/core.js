...
add('link', { rel: 'modulepreload', href: basePath + 'js/chunk-vendors.Dsi-x7X7.js', crossorigin: '' });
add('script', { type: 'module', src: basePath + 'js/app.D_qSd0lU.js', crossorigin: '' });
...
addEventListener('DOMContentLoaded', () => {
    ...
    polyfillScript.onload = function(){
        var entrySrc = basePath + 'js/app-legacy.Bm5Voca4.js';
