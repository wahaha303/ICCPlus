...
add('link', { rel: 'modulepreload', href: basePath + 'js/chunk-vendors.CKe1BZ24.js', crossorigin: '' });
add('script', { type: 'module', src: basePath + 'js/app.K0qu_XgK.js', crossorigin: '' });
...
addEventListener('DOMContentLoaded', () => {
    ...
    polyfillScript.onload = function(){
        var entrySrc = basePath + 'js/app-legacy.DxwLwU9k.js';
