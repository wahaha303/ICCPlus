...
add('link', { rel: 'modulepreload', href: basePath + 'js/chunk-vendors.DQVhQrH4.js', crossorigin: '' });
add('script', { type: 'module', src: basePath + 'js/app.BoHO89vm.js', crossorigin: '' });
add('script', {
type: 'module',
text: `
    import.meta.url;
...
addEventListener('DOMContentLoaded', () => {
    ...
    polyfillScript.onload = function(){
        var entrySrc = basePath + 'js/app-legacy.C003FpUk.js';
    ...
    legacyEntry.setAttribute('data-src', basePath + 'js/app-legacy.C003FpUk.js');
